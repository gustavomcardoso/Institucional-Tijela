				...
				<h5 class="c-blue">Deixe sua mensagem para nós, seja para dúvidas ou
					...
					<form action=" " class="pb-2 pt-3">
						<div class="form-group">
							<input type="text" name="" id="name" class="form-control" placeholder="Nome" aria-describedby="helpId">
						</div>
						<div class="form-group">
							<input type="text" name="" id="email" class="form-control" placeholder="E-mail" aria-describedby="helpId">
						</div>
						<div class="form-group">
							<input type="text" name="" id="telefone" class="form-control" placeholder="Telefone" aria-describedby="helpId">
						</div>
						<div class="form-group">
							<input type="text" name="" id="cpfcnpj" class="form-control" placeholder="CPF/CNPJ" aria-describedby="helpId">
						</div>
						<div class="form-group">
							<textarea type="text" name="" id="mensagem" class="form-control" placeholder="Mensagem" aria-describedby="helpId"> Mensagem</textarea>
						</div>
